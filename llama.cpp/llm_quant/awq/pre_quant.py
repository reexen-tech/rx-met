...
try:
    from tinychat.models import LlavaLlamaForCausalLM  # optional (llm-awq TinyChat)
except ImportError:

    class LlavaLlamaForCausalLM:  # noqa: N801 — placeholder so isinstance checks are safe
        pass
