...
import gc
# llm-awq: from .qmodule import ScaledActivation
...
def real_quantize_model_weight(model, w_bit, q_config, init_only=False):
    # llm-awq original packs INT4 via WQLinear + CUDA kernels; not ported.
    # This tree only exports AWQ-scaled FP16 HF for llama.cpp.
    raise NotImplementedError(
        "real INT4 pack is not included in llama.cpp/llm_quant; "
        "use export_awq_hf.py then convert_hf_to_gguf + llama-quantize"
    )
