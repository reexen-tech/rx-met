...
to_bf16_cuda_t ggml_get_to_bf16_cuda(ggml_type type) {
    switch (type) {
        ...
        case GGML_TYPE_TQ_K3:
            return reex_turboquant_to_t_tq_k3_cuda<nv_bfloat16>;
        case GGML_TYPE_TQ_V2:
            return reex_turboquant_to_t_tq_v2_cuda<nv_bfloat16>;
        case GGML_TYPE_TQ_V4:
            return reex_turboquant_to_t_tq_v4_cuda<nv_bfloat16>;
        case GGML_TYPE_TQ_V_POLAR2:
            return reex_turboquant_to_t_tq_v_polar2_cuda<nv_bfloat16>;
        case GGML_TYPE_TQ_V_POLAR4:
            return reex_turboquant_to_t_tq_v_polar4_cuda<nv_bfloat16>;
#endif
        default:
            return nullptr;
    }
...
#ifdef REEX_TURBOQUANT
        case GGML_TYPE_TQ_K3:
            return reex_turboquant_to_t_tq_k3_cuda<half>;
        case GGML_TYPE_TQ_V2:
            return reex_turboquant_to_t_tq_v2_cuda<half>;
        case GGML_TYPE_TQ_V4:
            return reex_turboquant_to_t_tq_v4_cuda<half>;
        case GGML_TYPE_TQ_V_POLAR2:
            return reex_turboquant_to_t_tq_v_polar2_cuda<half>;
        case GGML_TYPE_TQ_V_POLAR4:
...
#ifdef REEX_TURBOQUANT
        case GGML_TYPE_TQ_K3:
            return reex_turboquant_to_t_tq_k3_cuda<float>;
        case GGML_TYPE_TQ_V2:
            return reex_turboquant_to_t_tq_v2_cuda<float>;
        case GGML_TYPE_TQ_V4:
            return reex_turboquant_to_t_tq_v4_cuda<float>;
        case GGML_TYPE_TQ_V_POLAR2:
