...
static const std::vector<quant_option> QUANT_OPTIONS = {
    ...
    // === REEX_Q64 BEGIN ===  (requires ggml built with GGML_USE_REEX_Q64)
    { "Q4_0_64",  LLAMA_FTYPE_MOSTLY_Q4_0_64,  " 4-bit symmetric,  block=64 (hardware-aligned)",  },
    { "Q8_0_64",  LLAMA_FTYPE_MOSTLY_Q8_0_64,  " 8-bit symmetric,  block=64 (hardware-aligned)",  },
    { "Q4_1_64",  LLAMA_FTYPE_MOSTLY_Q4_1_64,  " 4-bit asymmetric, block=64 (hardware-aligned)",  },
    { "Q5_0_64",  LLAMA_FTYPE_MOSTLY_Q5_0_64,  " 5-bit symmetric,  block=64 (hardware-aligned)",  },
    { "Q5_1_64",  LLAMA_FTYPE_MOSTLY_Q5_1_64,  " 5-bit asymmetric, block=64 (hardware-aligned)",  },
    { "Q8_1_64",  LLAMA_FTYPE_MOSTLY_Q8_1_64,  " 8-bit sym+sum,    block=64 (hardware-aligned)",  },
    { "Q4_K_64",  LLAMA_FTYPE_MOSTLY_Q4_K_64,  " 4-bit K-quant,    sub-block=64 (hardware-aligned)",  },
    { "Q2_K_64",  LLAMA_FTYPE_MOSTLY_Q2_K_64,  " 2-bit K-quant,    sub-block=64 (hardware-aligned)",  },
    { "Q3_K_64",  LLAMA_FTYPE_MOSTLY_Q3_K_64,  " 3-bit K-quant,    sub-block=64 (hardware-aligned)",  },
    { "Q5_K_64",  LLAMA_FTYPE_MOSTLY_Q5_K_64,  " 5-bit K-quant,    sub-block=64 (hardware-aligned)",  },
    { "Q6_K_64",  LLAMA_FTYPE_MOSTLY_Q6_K_64,  " 6-bit K-quant,    sub-block=64 (hardware-aligned)",  },
    { "Q5_K_64S", LLAMA_FTYPE_MOSTLY_Q5_K_64S, " 5-bit K-quant SYMMETRIC, sub-block=64 (hardware-aligned)",  },
    { "Q4_K_64S", LLAMA_FTYPE_MOSTLY_Q4_K_64S, " 4-bit K-quant SYMMETRIC, sub-block=64 (hardware-aligned)",  },
    { "Q2_K_64S", LLAMA_FTYPE_MOSTLY_Q2_K_64S, " 2-bit K-quant SYMMETRIC, sub-block=64 (hardware-aligned)",  },
    // === REEX_Q64 END ===
